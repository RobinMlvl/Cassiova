...
export const Testimonial17 = (props: Testimonial17Props) => {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-28" id="tes">
...
export const Testimonial17Defaults: Testimonial17Props = {
  ...
  testimonials: [
    {
      testimonial:
        "Our experience with Cassiova has been exceptional. Their platform has helped us improve our Google Maps ranking and increase our revenue.",
      avatar: {
        src: "https://relume-assets.s3.amazonaws.com/placeholder-image.svg",
        alt: "Testimonial avatar 1",
      },
      name: "Alex Naud",
      position: "Comuna Hunter",
      companyName: "Comuna Tour",
      numberOfStars: 5,
    },
    {
      testimonial:
        "This Saas has been a game-changer for our business. Their AI review analysis and personalized recommendations have helped us address customer concerns and enhance our services.",
      avatar: {
        src: "https://relume-assets.s3.amazonaws.com/placeholder-image.svg",
      ...
      name: "Simon Chevalia",
      position: "Student",
      companyName: "L'eternel etudiant",
      numberOfStars: 5,
    },
    {
      testimonial:
