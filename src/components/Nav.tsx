...
import logo2 from "../assets/Cassiovapetit.png"
...
export const Navbar5 = (props: Navbar5Props) => {
  ...
  return (
    <nav className="fixed flex w-full items-center justify-between border-b border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]">
